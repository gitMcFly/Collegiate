...
//            targets: ["StudentNewspaper"]),
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/christopherweems/Resultto", .upToNextMajor(from: "0.0.2")),
        .package(url: "https://github.com/gitMcFly/MixedGroup", .upToNextMajor(from: "0.0.1")),
        .package(url: "https://github.com/christopherweems/Statehood", .upToNextMajor(from: "0.0.2")),
        .package(url: "https://github.com/christopherweems/unstandard", .upToNextMajor(from: "0.0.19")),
    ],
    targets: [
